...
/***/ "./src/js/modules/accordionNew.js":
/*!****************************************!*\
  !*** ./src/js/modules/accordionNew.js ***!
  \****************************************/
...
var accordionNew = function accordionNew(triggersSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (accordionNew);
...
var drop = function drop() {
  // drag         *
  // dragend      *
  // dragenter      -   Kogda object peretaskivaetsya nad "dropArea"
  // dragexit     *
  // dragleave      -   Kogda object za predelami  "dropArea"
  // dragover       -   Kogda object zavisaet nad "dropArea"  
  // dragstart    *
  // drop           -   Kogda object otpravlen v "dropArea"
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType) {
    markAll.forEach(function (mark) {
      ...
      mark.classList.remove('aniamted', 'fadeIn');
    });
    no.style.display = 'none';
    no.classList.remove('aniamted', 'fadeIn');

    if (markType) {
      markType.forEach(function (mark) {
        mark.style.display = 'block';
        mark.classList.add('aniamted', 'fadeIn');
      });
    } else {
      no.style.display = 'block';
      no.classList.add('aniamted', 'fadeIn');
    }
  };
...
var forms = function forms() {
  ...
  var message = {
    loading: 'Zagruzka...',
    success: 'Spasibo! Skoro mi s vami svyagemsya',
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = "hidden"; // ====== 1-st Version ====== //
        // document.body.classList.add('modal-open');          // ====== 2-nd Version ====== //
    ...
    function CloseModal() {
      ...
      document.body.style.overflow = ""; // ====== 1-st Version ====== //
      // document.body.classList.remove('modal-open');        // ====== 2-nd Version ====== //
  ...
  openByScroll('.fixed-gift'); // showModalByTime('.popup-consultation', 7000);
};
...
/***/ "./src/js/modules/scrollingNew.js":
/*!****************************************!*\
  !*** ./src/js/modules/scrollingNew.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var scrollingNew = function scrollingNew(upSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (scrollingNew);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    // getResource('http://localhost:3000/styles')                  // 1-st Version //
    (0,_services_requests__WEBPACK_IMPORTED_MODULE_4__.getResource)('assets/db.json') // .then(res => console.log(res))
    // .then(res => createCards(res))                           // 1-st Version //
    .then(function (res) {
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  function showSlides(n) {
    if (n > items.length) {
      // Vozvrat na 1-yi slide pri dostigenii konca //
      slideIndex = 1;
    }

    if (n < 1) {
      // Perenos v konec pri dostigenii nanchala //
      slideIndex = items.length;
    }

    items.forEach(function (item) {
      item.classList.add("animated"); // Dobablyaet vsem slides class "animated" //

      item.style.display = "none"; // Skrivaet vse slides //
    });
    items[slideIndex - 1].style.display = 'block'; // Zapusk animation s 0-ogo slide //
  }

  showSlides(slideIndex);

  function plusSlides(n) {
    // Peremennay "n" zadaet napravlenie //
    showSlides(slideIndex += n);
  }

  try {
    // V Sluchae prisutstviya peremennix 'prev' i 'next' //
    var prevBtn = document.querySelector(prev),
        nextBtn = document.querySelector(next);
    prevBtn.addEventListener('click', function () {
      plusSlides(-1); // Zadaet napravlenie //

      items[slideIndex - 1].classList.remove('slideInLeft');
      items[slideIndex - 1].classList.add('slideInRight'); // Zadaet napravlenie tekushemu slide //
    });
    nextBtn.addEventListener('click', function () {
      plusSlides(1); // Zadaet napravlenie //

      items[slideIndex - 1].classList.remove('slideInRight');
      items[slideIndex - 1].classList.add('slideInLeft'); // Zadaet napravlenie tekushemu slide //
    });
  } catch (e) {}
  ...
  function activateAnimation() {
    if (dir === 'vertical') {
      ...
      paused = setInterval(function () {
        plusSlides(1);
        items[slideIndex - 1].classList.add('slideInDown'); // Zadaet napravlenie tekushemu slide //
      }, 3000);
    } else {
      paused = setInterval(function () {
        // in case "horizontal" //
  ...
  activateAnimation(); // Zapusk 'Animation' //

  items[0].parentNode.addEventListener('mouseenter', function () {
    // V sluchae 'mouseenter' v "ParentNode" slida //
    clearInterval(paused); // Ostanavlivaet tekushiy "paused = setInterval" //                                          
  });
  items[0].parentNode.addEventListener('mouseleave', function () {
    // V sluchae 'mouseleave' iz "ParentNode" slida //
    activateAnimation(); // Povtorniy Zapusk 'Animation' //            
  });
};
...
/* harmony import */ var _modules_accordionNew__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accordionNew */ "./src/js/modules/accordionNew.js");
/* harmony import */ var _modules_burger__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/burger */ "./src/js/modules/burger.js");
/* harmony import */ var _modules_scrollingNew__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scrollingNew */ "./src/js/modules/scrollingNew.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]'); // showMoreStyles('.button-styles', '.styles-2');
  ...
  (0,_modules_accordionNew__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion-heading');
  (0,_modules_burger__WEBPACK_IMPORTED_MODULE_10__["default"])('.burger-menu', '.burger'); // scrolling('.pageup');

  (0,_modules_scrollingNew__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup');
